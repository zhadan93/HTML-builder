...
- node.js текущей версии LTS 16.15.0 в соответствии с заданием (проверку следует проводить с использованием указанной версии, иначе возможна некорректная работа скриптов);
- git последней версии 2.36.1 (могут возникунуть проблемы со вторым заданием, так как в Git Bash для Windows версий 2.35.1-2.35.4 присутствует баг, при котором некорректно обрабатывается событие при нажатии сочетания клавиш Ctrl+C. В связи с этим во второй задаче может не показываться прощальное сообщение при нажатии данного сочетания клавиш. Обновите Git Bash или попробуйте запускать скрипт в другом терминале).
